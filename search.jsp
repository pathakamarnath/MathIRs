...
<%
  ...
  PrintWriter pw2=new PrintWriter(path_of_tex_query);
	...
	String cs2=" ";
	String ignore2="(your LaTeX)";
	String modify1="xmlns";
	String modify2="mfrac linethickness";
	String modify3="<!-- end MathToWeb -->";
	String modify4="<!-- begin MathToWeb -->";		
	while(line2!=null)
	{
		if(line2.toLowerCase().indexOf(modify4.toLowerCase()) != -1 )
		{
			line2=line2.replace(modify4, "");		
				
		}
		if (line2.toLowerCase().indexOf(ignore2.toLowerCase()) != -1 )
			{
			line2=br2.readLine();
			continue;					
			}
			
		if(line2.toLowerCase().indexOf(modify1.toLowerCase()) != -1 )
		{
			line2="<math>";
				
		}
		if(line2.toLowerCase().indexOf(modify2.toLowerCase()) != -1 )
		{
			line2="<mfrac>";
				
		}
		if(line2.toLowerCase().indexOf(modify3.toLowerCase()) != -1 )
		{
			line2=line2.replace(modify3, "");		
  ...
  String textinbold1="<b>The query string entered by you is: </b>";   	
  String textprint="<b>Text content is: </b>";
  String mathprint="<b>Math content is: </b>";
   String representation="<b>Compact String Representation is: </b>";
 	 out.print(textinbold1);
	out.println(cs2);
	String totalcontent=queryString;    	
        String mathcontent = "";
        if (totalcontent.contains("<math")) {
            StringBuilder sb = new StringBuilder(totalcontent);
            String startstring = "<math";
            String endstring = "/math>";
            int i1 = 0, i2 = 0;
            while ((i1 = sb.indexOf(startstring, i1)) != -1) {
                i2 = sb.indexOf(endstring, i1 + 1) + endstring.length();
                mathcontent += sb.substring(i1, i2);
                sb.delete(i1, i2);
            }              
            totalcontent = sb.toString();
            totalcontent = totalcontent.trim();
        }    
        
        out.print(textprint);    	   	
    	out.println(totalcontent);	    	
    	out.print(mathprint);    	   	
    	out.println(mathcontent);
    	queryString=mathcontent;     
